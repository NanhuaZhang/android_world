...
class Doubao(base_agent.EnvironmentInteractingAgent):
...
Action: {{"action_type": "status", "goal_status": "infeasible"}}"""
    ...
    step_data['prompt_tokens'] = raw_response.json()['usage']['prompt_tokens']
    step_data['completion_tokens'] = raw_response.json()['usage']['completion_tokens']
